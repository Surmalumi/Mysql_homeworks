...
CREATE TABLE `movie` (
  ...
  `genre` varchar(145) NOT NULL, -- жанр
  `director` varchar(145) NOT NULL, -- режисер
  `producer` varchar(145) DEFAULT NULL, -- продюсер
  `compositor` varchar(145) DEFAULT NULL, -- композитор
  `actor_1` varchar(145) NOT NULL, -- актер или актриса 1
  `actor_2` varchar(145) DEFAULT NULL, -- актер или актриса 2
...
INSERT INTO movie VALUES (DEFAULT, 'The Gentlemen', 'Criminal', 'Guy Ritchie',  'Matthew Anderson', 'Christopher Benstead', 'Matthew McConaughey', DEFAULT, DEFAULT, '2019', 'USA', NULL);
INSERT INTO movie VALUES (DEFAULT, 'The Matrix', 'Fantastic', 'Lana Wachowski, Lilly Wachowski',  'Joel Silver', 'Don Davis', 'Keanu Reeves', 'Carrie-Anne Moss', DEFAULT, '1999', 'USA', NULL);

INSERT INTO movie VALUES 
(DEFAULT, 'Titanic', 'Melodrama', 'James Cameron',  'James Cameron', 'James Horner', 'Kate Winslet', 'Leonardo DiCaprio', DEFAULT, '1997', 'USA', NULL), (DEFAULT, 'The Lord of the Rings: The Fellowship of the Ring', 'Fantasy', 'Peter Jackson',  'Peter Jackson', 'Howard Shore', 'Ian McKellen', 'Elijah Wood', DEFAULT, '2001', 'New Zealand', NULL), (DEFAULT, 'The Green Mile', 'Drama', 'Frank Darabont',  'Frank Darabont', 'Thomas Newman', 'Tom Hanks', DEFAULT, DEFAULT, '1999', 'USA', NULL), (DEFAULT, 'Forrest Gump', 'Drama', 'Robert Zemeckis',  'Wendy Finerman', 'Alan Silvestri', 'Tom Hanks', DEFAULT, DEFAULT, '1994', 'USA', NULL), (DEFAULT, 'The Lion King', 'Cartoon', 'Roger Allers',  'Don Hahn', 'Hans Zimmer', 'Matthew Broderick', 'Jeremy Irons', DEFAULT, '1994', 'USA', NULL), (DEFAULT, 'Back to the Future', 'Adventure', 'Robert Zemeckis',  'Neil Canton', 'Alan Silvestri', 'Michael J. Fox', 'Christopher Lloyd', DEFAULT, '1985', 'USA', NULL), (DEFAULT, 'Inception', 'Fantastic', 'Christopher Nolan',  'Christopher Nolan', 'Hans Zimmer', 'Leonardo DiCaprio', 'Joseph Gordon-Levitt', DEFAULT, '2010', 'USA', NULL), (DEFAULT, 'Gentlemen of fortune', 'Comedy', 'Aleksander Seryi', DEFAULT, 'Gennadiy Gladkov', 'Evgeniy Leonov', 'Georgiy Vitsin', DEFAULT, '1971', 'USSR', NULL), (DEFAULT, 'Home Alone', 'Comedy', 'Chris Columbus', 'Tarquin Gotch', 'John Williams', 'Macaulay Culkin', 'Joe Pesci', DEFAULT, '1990', 'USA', NULL), (DEFAULT, 'City Lights', 'Comedy', 'Charles Chaplin', 'Charles Chaplin', 'Charles Chaplin', 'Charles Chaplin', 'Virginia Cherrill', DEFAULT, '1931', 'USA', NULL), (DEFAULT, 'Harry Potter and the Sorcerers Stone', 'Fantasy', 'Chris Columbus', 'Todd Arnow', 'John Williams', 'Daniel Radcliffe', 'Alan Rickman', DEFAULT, '2001', 'UK', NULL),
(DEFAULT, 'Treasure island', 'Cartoon', 'David Cherkasskiy', DEFAULT, 'Vladimir Vystryakov', 'Vladimir Zadneprovskiy', 'Armen Djigarhanyan', DEFAULT, '1988', 'USSR', NULL), 
(DEFAULT, 'The Crow', 'Fantasy', 'Alex Proyas', 'Jeff Most', 'Graeme Revell', 'Brandon Lee', DEFAULT, DEFAULT, '1994', 'USA', NULL);
...
CREATE TABLE reviews (
	...
	PRIMARY KEY (movie_id, user_id), -- PK по отзыву и лайку, чтобы гарантировать, что пользователь может оставить только один отзыв
